...
2. Your package will get a DOI only after you make a release. Create a new release as described in [README.dev.md](git@github.com:SDCCA/dgl_ptm/blob/main/README.dev.md#33-github)
