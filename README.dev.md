# `dgl_abm` developer documentation
...
# install dgl_abm as an editable package
...
The second is to use `tox`, which can be installed separately (e.g. with `pip install tox`), i.e. not necessarily inside the virtual environment you use for installing `dgl_abm`, but then builds the necessary virtual environments itself by simply running:
...
cd $(mktemp -d dgl_abm.XXXXXX)
git clone git@github.com:SDCCA/dgl_abm .
...
Visit
[https://test.pypi.org/project/dgl_abm](https://test.pypi.org/project/dgl_abm)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d dgl_abm-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple dgl_abm
```
...
Don't forget to also make a [release on GitHub](https://github.com/SDCCA/dgl_abm/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.